...
const products = [
    {
        ...
        price: 89.99,
        category: 'Shirts',
        description: 'A lightweight linen blend shirt perfect for summer days. Features a relaxed fit and breathable fabric.',
        sizes: ['S', 'M', 'L', 'XL'],
    ...
    },
    {
        ...
        price: 75.00,
        category: 'Pants',
        description: 'Comfortable chinos with a relaxed fit. Made from high-quality cotton with a slight stretch for comfort.',
    ...
    },
    {
        ...
        price: 120.00,
        category: 'Outerwear',
        description: 'A lightweight summer jacket perfect for those cooler summer evenings. Features a water-resistant outer layer.',
        sizes: ['S', 'M', 'L', 'XL'],
    ...
    },
    {
        ...
        price: 35.00,
        category: 'Shirts',
        description: 'A classic t-shirt made from 100% organic cotton. Features a comfortable fit and durable construction.',
        sizes: ['S', 'M', 'L', 'XL', 'XXL'],
    ...
    },
    {
        ...
        price: 85.00,
        category: 'Pants',
        description: 'Slim fit jeans made from premium denim. Features a modern cut and comfortable stretch.',
        sizes: ['30', '32', '34', '36'],
    ...
    },
    {
        ...
        price: 150.00,
        category: 'Outerwear',
        description: 'A versatile casual blazer that can be dressed up or down. Made from a lightweight wool blend.',
        sizes: ['S', 'M', 'L'],
    ...
    },
    {
        ...
        price: 45.00,
        category: 'Shirts',
        description: 'A classic polo shirt made from pique cotton. Features a comfortable fit and timeless style.',
        sizes: ['S', 'M', 'L', 'XL'],
    ...
    },
    {
        ...
        price: 65.00,
        category: 'Pants',
        description: 'Comfortable cargo shorts with multiple pockets. Made from durable cotton with a water-resistant finish.',
        sizes: ['30', '32', '34', '36', '38'],
